...
mcp.post("/", async c => {
  ...
  if(body.method === "initialize") return c.json({jsonrpc:"2.0",id:body.id,result:{protocolVersion:"2025-06-18",capabilities:{tools:{}},serverInfo:{name:"manto",version:"1.0.1"}}});
