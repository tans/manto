...
| **SkillHub（WorkBuddy 技能市场）** ✅ | **v1.1.0 已上架** | 见下方「SkillHub 发布流程」 | `@user_e866c542/manto-geo` v1.1.0 已上架（versionId `300529`）；公开详情页与 CLI 均可查到新版，**运营策略见 [GROWTH.md 1.1](GROWTH.md#11-skillhub-专项运营已上架优先级最高)** |
...
**09-09 状态**：v1.1.0 已上架，versionId `300529`，changelog 为「新增安装→首篇发布→再次发布引导；增加 release job 同步 changelog 的幂等模板」；公开详情页显示“今天更新 v1.1.0”，科恩实验室与云鼎实验室均为“安全，无风险”。
